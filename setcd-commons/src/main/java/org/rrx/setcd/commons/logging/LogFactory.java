 ...
 */
package org.rrx.setcd.commons.logging;
...
public class LogFactory {
    ...
    static {
        ...
        if(logType != null){
            if(logType.equalsIgnoreCase("slf4j")){
                tryImplementation("org.slf4j.Logger", "org.rrx.setcd.commons.logging.SLF4JImpl");
            }else if(logType.equalsIgnoreCase("log4j")){
                tryImplementation("org.apache.log4j.Logger", "org.rrx.setcd.commons.logging.Log4jImpl");
            }else if(logType.equalsIgnoreCase("log4j2")){
                tryImplementation("org.apache.logging.log4j.Logger", "org.rrx.setcd.commons.logging.Log4j2Impl");
            }else if(logType.equalsIgnoreCase("commonsLog")){
                tryImplementation("org.apache.commons.logging.LogFactory",
                        "org.rrx.setcd.commons.logging.JakartaCommonsLoggingImpl");
            }else if(logType.equalsIgnoreCase("jdkLog")){
                tryImplementation("java.util.logging.Logger", "org.rrx.setcd.commons.logging.Jdk14LoggingImpl");
            }
        }
    ...
    public static synchronized void selectLog4JLogging() {
        try {
            ...
            Class implClass = Resources.classForName("org.rrx.setcd.commons.logging.Log4jImpl");
            logConstructor = implClass.getConstructor(new Class[] { String.class });
        } catch (Throwable t) {
            //ignore
        }
    ...
    public static synchronized void selectJavaLogging() {
        try {
            ...
            Class implClass = Resources.classForName("org.rrx.setcd.commons.logging.Jdk14LoggingImpl");
            logConstructor = implClass.getConstructor(new Class[] { String.class });
        } catch (Throwable t) {
            //ignore
        }
